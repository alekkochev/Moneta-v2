...
serve(async (req) => {
  ...
  try {
    ...
    // Кратка потврда во мејлот; сите детали се во приложената испратница-фактура (PDF).
    const text =
    ...
    // PDF испратницата-фактурата ја генерира прелистувачот (invoice-pdf.js) и ја праќа како base64
