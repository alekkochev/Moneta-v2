...
// ========================================
// ЗАШТИТА: избриши го логин cookie-то при напуштање/релоад на страницата
// → секогаш кога повторно се отвори страницата бара лозинка
// ========================================
window.addEventListener('pagehide', () => {
    try {
        document.cookie = 'moneta_auth=; Path=/; Max-Age=0';
    } catch (e) { /* ignore */ }
});
